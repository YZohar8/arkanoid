...
public class TestForAss2 {
    ...
    private geometric.objects.Point previousP = null;

    /**
     * Is in range of epsilon boolean.
     *
     * @param x the x
     * @param y the y
     * @return the boolean
    ...
    public void checkPoint() {
        geometric.objects.Point p1 = new geometric.objects.Point(3.5, 4.6);
        geometric.objects.Point p2 = new geometric.objects.Point(3.5, 4.6);
        geometric.objects.Point p3 = new geometric.objects.Point(5.4, 7.8);
        geometric.objects.Point p4 = new geometric.objects.Point(-5.4, 7.8);
        geometric.objects.Point p5 = new geometric.objects.Point(-5.4, -7.8);
        geometric.objects.Point p6 = new geometric.objects.Point(5.4, -7.8);
        geometric.objects.Point p7 = new geometric.objects.Point(0.0, 0.0);
        ...
        System.out.println("passed tests for geometric.Point");
    }
    ...
    public void checkLine() {
        ...
        geometric.objects.Point c1 = new Point(49.45, 68.3);
        geometric.objects.Point c2 = new geometric.objects.Point(93.23, 27.3);
        // is same as lf
...
//            geometric.Line t = new geometric.Line(136.24, 57.79,180.0, 80.04);
        ...
        geometric.objects.Point t1 = new geometric.objects.Point(100.0, 160.0);
        geometric.objects.Point s1 = new geometric.objects.Point(120.0, 160.0);
        geometric.objects.Point r1 = new geometric.objects.Point(1400.0, 160.0);
        ...
        assert (f.middle().equals(new geometric.objects.Point(71.34, 47.8)));
        assert (f.length() == c1.distance(c2));
        assert (f.equals(f));
        assert (f.equals(l2f));
        assert (!f.equals(g));

        assert (f.isIntersecting(l2f));
...
//            assert (l3.intersectionWith(l15) == null);
        ...
        assert (n.intersectionWith(p).equals(new geometric.objects.Point(40.0, 40.0)));
        assert (s.intersectionWith(g).equals(new geometric.objects.Point(119.95907554822693, 49.521427043314844)));
        assert (f.intersectionWith(g).equals(new geometric.objects.Point(87.242330580114, 32.907456514740204)));
        assert (a.intersectionWith(b).equals(new geometric.objects.Point(0.0, 27.02660885723134)));

        //added tests
        assert (a.isIntersecting(j1));
        assert (a.intersectionWith(j1).equals(new geometric.objects.Point(0.0, 0.0)));

        assert (k1.isIntersecting(j1));
        assert (k1.intersectionWith(j1).equals(new geometric.objects.Point(120.0, 0.0)));

        assert (k1.isIntersecting(l1));
        assert (k1.intersectionWith(l1).equals(new geometric.objects.Point(120.0, 6.666666666666657)));

        assert (j1.isIntersecting(l1));
        assert (j1.intersectionWith(l1).equals(new geometric.objects.Point(130.0, 0.0)));

        assert (m1.isIntersecting(p));
        assert (m1.intersectionWith(p).equals(new geometric.objects.Point(40.0, 40.0)));

        assert (n1.isIntersecting(i));
        assert (n1.intersectionWith(i).equals(new geometric.objects.Point(20.0, 80.0)));


        System.out.println("passed tests for geometric.Line");
    ...
    public void checkVelocity() {
        ...
        geometric.objects.Point p1 = new geometric.objects.Point(3.5, 7.8);
        geometric.objects.Point p2 = new geometric.objects.Point(-3.5, 7.8);
        geometric.objects.Point p3 = new geometric.objects.Point(-3.5, -7.8);
        geometric.objects.Point p4 = new geometric.objects.Point(3.5, -7.8);

        assert (v1.applyToPoint(p1).equals(new geometric.objects.Point(7.0, 14.5)));
        assert (v1.applyToPoint(p2).equals(new geometric.objects.Point(0.0, 14.5)));
        assert (v1.applyToPoint(p3).equals(new geometric.objects.Point(0.0, -1.1)));
        assert (v1.applyToPoint(p4).equals(new geometric.objects.Point(7.0, -1.1)));

        assert (v2.applyToPoint(p1).equals(new geometric.objects.Point(0.0, 14.5)));
        assert (v2.applyToPoint(p2).equals(new geometric.objects.Point(-7.0, 14.5)));
        assert (v2.applyToPoint(p3).equals(new geometric.objects.Point(-7.0, -1.1)));
        assert (v2.applyToPoint(p4).equals(new geometric.objects.Point(0.0, -1.1)));

        assert (v3.applyToPoint(p1).equals(new geometric.objects.Point(0.0, 1.1)));
        assert (v3.applyToPoint(p2).equals(new geometric.objects.Point(-7.0, 1.1)));
        assert (v3.applyToPoint(p3).equals(new geometric.objects.Point(-7.0, -14.5)));
        assert (v3.applyToPoint(p4).equals(new geometric.objects.Point(0.0, -14.5)));

        assert (v4.applyToPoint(p1).equals(new geometric.objects.Point(7.0, 1.1)));
        assert (v4.applyToPoint(p2).equals(new geometric.objects.Point(0.0, 1.1)));
        assert (v4.applyToPoint(p3).equals(new geometric.objects.Point(0.0, -14.5)));
        assert (v4.applyToPoint(p4).equals(new geometric.objects.Point(7.0, -14.5)));

        assert (v5.applyToPoint(p1).equals(new geometric.objects.Point(3.5, 7.8)));
        assert (v5.applyToPoint(p2).equals(new geometric.objects.Point(-3.5, 7.8)));
        assert (v5.applyToPoint(p3).equals(new geometric.objects.Point(-3.5, -7.8)));
        assert (v5.applyToPoint(p4).equals(new geometric.objects.Point(3.5, -7.8)));

//         geometric.Point p4 = new geometric.Point(3.5, -7.8);
        assert (v6.applyToPoint(p4).equals(new geometric.objects.Point(8.9, -7.8)));
//        assert (v7.applyToPoint(p4).equals(new geometric.Point(3.5, -2.4)));
        assert (v7.applyToPoint(p4).equals(new geometric.objects.Point(3.5, -13.2)));
//        assert (v8.applyToPoint(p4).equals(new geometric.Point(((6.0 * Math.sin(Math.PI/6)))
//                + 3.5, (6.0 * Math.sin(Math.PI / 3)) -7.8)));
        assert (v8.applyToPoint(p4).equals(new geometric.objects.Point(((6.0 * Math.sin(Math.PI / 6)))
                + 3.5, -(6.0 * Math.sin(Math.PI / 3)) - 7.8)));

        System.out.println("passed tests for geometric.Velocity");
    ...
    public void checkBall() {
        geometric.objects.Point c1 = new geometric.objects.Point(50.5, 60.3);
        geometric.objects.Point c2 = new geometric.objects.Point(0.0, 0.0);
        geometric.objects.Point c3 = new geometric.objects.Point(-90.8, 130.5);
        geometric.objects.Point c4 = new geometric.objects.Point(-90.8, -130.5);
        geometric.objects.Point c5 = new geometric.objects.Point(90.8, -130.5);
        geometric.objects.Point c6 = new geometric.objects.Point(90.8, 130.5);
        geometric.objects.Point c7 = new geometric.objects.Point(150.0, 150.0);
        geometric.objects.Point c8 = new geometric.objects.Point(100.0, 100.0);
        ...
        Ball b9 = new Ball(c7, 50, Color.BLUE);
        Ball b10 = new Ball(c8, 100, Color.GREEN);
        Ball b11 = new Ball(c7, 50, Color.BLUE);
        Ball b12 = new Ball(c7, 50, Color.BLUE);

        //check that program will not fail:
        Ball b13 = new Ball(c6, -9, Color.ORANGE);   // radius is negative
        Ball b14 = new Ball(c6, 150, Color.ORANGE);
...
//            g.show(t);
        ...
        System.out.println("passed tests for geometric.Ball");
    ...
    public void checkBallCoords(Ball b) {
        ...
        this.previousP = new geometric.objects.Point(b.getX(), b.getY());
    }
